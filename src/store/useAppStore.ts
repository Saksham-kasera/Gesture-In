...
const PERF_PROFILES: Record<PerformanceProfile['tier'], PerformanceProfile> = {
  high: { tier: 'high', particleCount: 2200, bloomEnabled: true, shadowsEnabled: true, dprCap: 2 },
  medium: { tier: 'medium', particleCount: 1100, bloomEnabled: true, shadowsEnabled: false, dprCap: 1.5 },
  low: { tier: 'low', particleCount: 450, bloomEnabled: false, shadowsEnabled: false, dprCap: 1 },
};
